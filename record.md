...
6个爻先保存成一个数组b(原来就是数组则无需额外创建,使用对应数组名即可)，然后前3个保存为数组b，后3个保存为数组c
...
---
单独创建结构体hun_yuan用于保存八个本宫卦对应内卦和外卦的地支和五行(写在一起)，还要有个索引匹配8个本宫卦，乾是111,震是122,坎是212,艮是221，坤是222,巽是211，离是121，兑是112
